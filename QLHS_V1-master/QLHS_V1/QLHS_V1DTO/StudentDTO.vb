Public Class StudentDTO
    ...
    Public Sub New(str_Id As String, i_Gender As Integer, str_Name As String, str_Address As String, day_Brithday As DateTime, strclass As String)
        Me.str_Id = str_Id
